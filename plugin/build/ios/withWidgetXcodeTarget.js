...
const addBroadcastExtensionXcodeTarget = async (proj, { appName, extensionName, extensionBundleIdentifier, currentProjectVersion, marketingVersion, devTeamId, topLevelFiles, topLevelFolders, }) => {
...
const addBuildPhases = (proj, { productFile, targetUuid, frameworkPaths, extensionName, sourceFiles, resourceFiles }) => {
...
const addChildPbxGroup = (proj, extensionName, files, parent) => {
    // Add PBX group
...
const withWidgetXcodeTarget = (config, { devTeamId, targetName, topLevelFiles, topLevelFolders }) => {
