...
// const host = process.env.SERVICE_NAME?.includes('aoe4') ? 'aoeiv.net' : 'legacy.aoe2companion.com';
const host = process.env.SERVICE_NAME?.includes('aoe4') ? 'aoeiv.net' : 'localhost:3334';
