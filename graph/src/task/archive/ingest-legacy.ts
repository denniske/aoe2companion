...
import {
    fetchLeaderboardRecentMatches, fetchLeaderboardRecentMatchesLegacy, setValue
} from "../../serverless/src/helper";
...
async function fetchLeaderboardData(leaderboardId: number) {
    ...
    let entries = await fetchLeaderboardRecentMatchesLegacy(leaderboardId, 50);
