...
export type Age = 'DarkAge' | 'FeudalAge' | 'CastleAge' | 'ImperialAge';

export function getAgeFromAgeTech(ageTech: Tech): Age | null {
    // if (ageTech === 'DarkAge') return 'Dark';
    if (ageTech === 'FeudalAge') return 'FeudalAge';
    if (ageTech === 'CastleAge') return 'CastleAge';
    if (ageTech === 'ImperialAge') return 'ImperialAge';
    return null;
}
...
const techEffectDictInternal = {
    ...
    Cranequins: {
        tech: 'Cranequins',
        effect: {
            attack: '+2 attack against infantry',
            range: '+1',
        },
    },
    OrdonnanceCompanies: {
        tech: 'OrdonnanceCompanies',
        civ: 'Franks',
        effect: {
            other: 'cost -40% gold',
        },
    ...
    Hamask: {
        ...
        civ: 'Danes',
        effect: {
            attack: '+1 per 10% hit points lost',
        },
    },
    NorthmensFury: {
        tech: 'NorthmensFury',
    ...
    ClericalRecruitment: {
        tech: 'ClericalRecruitment',
        civ: 'Saxons',
        effect: {
            range: '+1 conversion range',
            creationSpeed: '+33%',
        },
    },
    ShieldWall: {
        ...
        civ: 'Saxons',
        effect: {
            armor: '+1/+1 per 15 friendly infantry nearby (max +3/+3)',
        },
    },
    VendelLegacy: {
        tech: 'VendelLegacy',
        civ: 'Varangians',
        effect: {
            attack: 'gives trample damage (+0.5 blast radius, flat 5 damage)',
        },
    },
    Gothikon: {
        tech: 'Gothikon',
        civ: 'Varangians',
        effect: {
            other: 'throws axes periodically (2 charged ranged attacks every 30 seconds)',
        },
    },
    ...
    Logistica: {
        ...
        civ: 'Byzantines',
        effect: {
            attack: 'adds trample damage (+0.5 blast radius, flat 5 damage)',
        },
    },
    Chatras: {
        tech: 'Chatras',
    ...
    'Ballistics-HearthTroop': {
        tech: 'Ballistics',
        effect: {
            accuracy: 'hit moving targets, only charged attack',
        },
    },
    'Ballistics-louchuan': {
        tech: 'Ballistics',
    ...
    'Fletching-HearthTroop': {
        tech: 'Fletching',
        effect: {
            attack: '+1, only charged attack',
            range: '+1, only charged attack',
            sight: '+1',
        },
    },
    'BodkinArrow-HearthTroop': {
        tech: 'BodkinArrow',
        effect: {
            attack: '+1, only charged attack',
            range: '+1, only charged attack',
