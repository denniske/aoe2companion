...
export const translateStringsSourceData: Record<string, any> = {
    ...
    // 'it': require('../../../app4/assets/data/it/strings.json.lazy'),
    // 'pt': require('../../../app4/assets/data/pt/strings.json.lazy'),
    // 'ru': require('../../../app4/assets/data/ru/strings.json.lazy'),
    ...
    // 'ko': require('../../../app4/assets/data/ko/strings.json.lazy'),
    // 'zh-hans': require('../../../app4/assets/data/zh-hans/strings.json.lazy'),
    // 'zh-hant': require('../../../app4/assets/data/zh-hant/strings.json.lazy'),
};
