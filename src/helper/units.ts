...
const unitIcons: UnitIconDict = {
    ...
    'EliteArambai': require('../../assets/units/EliteArambai.png'),
    'EliteBallistaElephant': require('../../assets/units/EliteBallistaElephant.png'),
    'EliteBattleElephant': require('../../assets/units/EliteBattleElephant.png'),
    'EliteBerserk': require('../../assets/units/EliteBerserk.png'),
    ...
    'EliteBoyar': require('../../assets/units/EliteBoyar.png'),
    'EliteCamelArcher': require('../../assets/units/EliteCamelArcher.png'),
    'EliteCannonGalleon': require('../../assets/units/EliteCannonGalleon.png'),
    'EliteCaravel': require('../../assets/units/EliteCaravel.png'),
    'EliteCataphract': require('../../assets/units/EliteCataphract.png'),
    'EliteCenturion': require('../../assets/units/EliteCenturion.png'),
    'EliteChakramThrower': require('../../assets/units/EliteChakramThrower.png'),
    'EliteChampiWarrior': require('../../assets/units/EliteChampiWarrior.png'),
    'EliteChuKoNu': require('../../assets/units/EliteChuKoNu.png'),
    'EliteCompositeBowman': require('../../assets/units/EliteCompositeBowman.png'),
    'EliteConquistador': require('../../assets/units/EliteConquistador.png'),
    'EliteCoustillier': require('../../assets/units/EliteCoustillier.png'),
    ...
    'EliteFireArcher': require('../../assets/units/EliteFireArcher.png'),
    'EliteFireLancer': require('../../assets/units/EliteFireLancer.png'),
    'EliteGbeto': require('../../assets/units/EliteGbeto.png'),
    'EliteGenitour': require('../../assets/units/EliteGenitour.png'),
    'EliteGenoeseCrossbowman': require('../../assets/units/EliteGenoeseCrossbowman.png'),
    'EliteGhulam': require('../../assets/units/EliteGhulam.png'),
    'EliteGuechaWarrior': require('../../assets/units/EliteGuechaWarrior.png'),
    'EliteHuskarl': require('../../assets/units/EliteHuskarl.png'),
    'EliteHussiteWagon': require('../../assets/units/EliteHussiteWagon.png'),
    'EliteIbirapemaWarrior': require('../../assets/units/EliteIbirapemaWarrior.png'),
    'EliteIronPagoda': require('../../assets/units/EliteIronPagoda.png'),
    'EliteJaguarWarrior': require('../../assets/units/EliteJaguarWarrior.png'),
    'EliteJanissary': require('../../assets/units/EliteJanissary.png'),
    'EliteKamayuk': require('../../assets/units/EliteKamayuk.png'),
    'EliteKarambitWarrior': require('../../assets/units/EliteKarambitWarrior.png'),
    'EliteKeshik': require('../../assets/units/EliteKeshik.png'),
    'EliteKipchak': require('../../assets/units/EliteKipchak.png'),
    'EliteKona': require('../../assets/units/EliteKona.png'),
    'EliteKonnik': require('../../assets/units/EliteKonnik.png'),
    'EliteKonnikDismounted': require('../../assets/units/EliteKonnikDismounted.png'),
    'EliteLeitis': require('../../assets/units/EliteLeitis.png'),
    'EliteLiaoDao': require('../../assets/units/EliteLiaoDao.png'),
    'EliteLongboat': require('../../assets/units/EliteLongboat.png'),
    'EliteLongbowman': require('../../assets/units/EliteLongbowman.png'),
    'EliteMagyarHuszar': require('../../assets/units/EliteMagyarHuszar.png'),
    'EliteMameluke': require('../../assets/units/EliteMameluke.png'),
    'EliteMangudai': require('../../assets/units/EliteMangudai.png'),
    'EliteMonaspa': require('../../assets/units/EliteMonaspa.png'),
    'EliteObuch': require('../../assets/units/EliteObuch.png'),
    'EliteOrganGun': require('../../assets/units/EliteOrganGun.png'),
    'ElitePlumedArcher': require('../../assets/units/ElitePlumedArcher.png'),
    'EliteRatha': require('../../assets/units/EliteRatha.png'),
    'EliteRattanArcher': require('../../assets/units/EliteRattanArcher.png'),
    'EliteSamurai': require('../../assets/units/EliteSamurai.png'),
    'EliteSerjeant': require('../../assets/units/EliteSerjeant.png'),
    'EliteShotelWarrior': require('../../assets/units/EliteShotelWarrior.png'),
    'EliteShrivamshaRider': require('../../assets/units/EliteShrivamshaRider.png'),
    'EliteSkirmisher': require('../../assets/units/EliteSkirmisher.png'),
    'EliteSteppeLancer': require('../../assets/units/EliteSteppeLancer.png'),
    'EliteTarkan': require('../../assets/units/EliteTarkan.png'),
    'EliteTempleGuard': require('../../assets/units/EliteTempleGuard.png'),
    'EliteTeutonicKnight': require('../../assets/units/EliteTeutonicKnight.png'),
    'EliteThrowingAxeman': require('../../assets/units/EliteThrowingAxeman.png'),
    'EliteTigerCavalry': require('../../assets/units/EliteTigerCavalry.png'),
    'EliteTurtleShip': require('../../assets/units/EliteTurtleShip.png'),
    'EliteUniqueResearch': require('../../assets/units/EliteUniqueResearch.png'),
    'EliteUrumiSwordsman': require('../../assets/units/EliteUrumiSwordsman.png'),
    'EliteWarElephant': require('../../assets/units/EliteWarElephant.png'),
    'EliteWarWagon': require('../../assets/units/EliteWarWagon.png'),
    'EliteWhiteFeatherGuard': require('../../assets/units/EliteWhiteFeatherGuard.png'),
    'EliteWoadRaider': require('../../assets/units/EliteWoadRaider.png'),
