...
export const civHistoryList = [
    ...
    require('../../assets/history/civs2/history_danes.png'),
    ...
    require('../../assets/history/civs2/history_mapuche.png'),
    require('../../assets/history/civs/history_mayans.png'),
    require('../../assets/history/civs2/history_muisca.png'),
    ...
    require('../../assets/history/civs2/history_saxons.png'),
    ...
    require('../../assets/history/civs2/history_tupi.png'),
    require('../../assets/history/civs/history_turks.png'),
    require('../../assets/history/civs2/history_varangians.png'),
