    ...
    "overview": [
        {
            ...
            "list": [
                ...
                "Units trained, research completed, and resources dropped off generate tax Gold that can be collected by Imperial Officials.",
                "Begin in the Tang Dynasty — increases Scout line of sight +30% and provides access to the Village.",
                "Enter a new Dynasty by building both Landmarks from an Age — provides access to special bonuses, unique units, and buildings.",
