...
async function main() {
    ...
    const urls = {
        ...
        techs: await getFandomUrls(['https://ageofempires.fandom.com/wiki/Technology_(Age_of_Empires_II)', 'https://ageofempires.fandom.com/wiki/Unique_technology'], techIds),
    };
