    ...
    return (
        <View style={styles.menu}>
            <Picker
                ...
                anchor={() => <FontAwesome5 solid="true" name="gratipay" size={18} style={styles.icon} />}
...
export default function GuidePage() {
    ...
    if (Platform.OS === 'web') {
        ...
        return <iframe id="guide-iframe" style={{ border: 'none', background: 'white' }} height="100%" src={url}></iframe>;
    }
        ...
        navigation.setOptions({
            headerRight: () => (
                <GuideHeaderBookmark
                    url={url}
                    guides={guides.data}
                    onBookmarkPressed={(guideId: string) => {
