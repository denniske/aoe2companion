...
export default function OverlaySettingsPage() {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            <MyText>
                The overlay will only be displayed when the AoE II DE game is running. To verify this is working start the game and press the button
                below.
            </MyText>
            <Space />
            ...
            <MyText>
                You can send a test notification. If the windows notification pops up, the overlay should show. You don't need to click on the
                notification.
            </MyText>
            <Space />
