...
export function getCivIconLocal(civ: string) {
    return { uri: 'https://www.aoe2companion.com/aoe2/de/civilizations/chinese.png' }; // Todo: Remove fake url
...
export const genericCivIcon = { uri: 'https://www.aoe2companion.com/aoe2/de/civilizations/chinese.png' }; // Todo: Remove fake url
// require('../../assets/civilizations/generic.png');