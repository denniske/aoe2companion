...
const unitIcons: UnitIconDict = {
    ...
    'MonkCatholic': require('../../../app/assets/units/MonkCatholic.png'),
    'MonkHindu': require('../../../app/assets/units/MonkHindu.png'),
    'MonkMuslim': require('../../../app/assets/units/MonkMuslim.png'),
    'MonkNative': require('../../../app/assets/units/MonkNative.png'),
    'MonkOrthodox': require('../../../app/assets/units/MonkOrthodox.png'),
